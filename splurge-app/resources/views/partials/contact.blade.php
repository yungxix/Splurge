<div class="ml-8 md:ml-10 mt-4 mb-10 md:mb-12">
    ...
    <p class="lix">{{ config('app.name') }} Weddings and Party Planning</p>
    <div class="mt-4">
    ...
    <p class="mt-8">
        <a class="rounded-md md:rounded-lg text-white bg-splarge-800 hover:bg-splarge-900 ring-0 hover:ring-1 px-6 py-4" href="#">Tell us about your next event</a>
    </p>
</div>
