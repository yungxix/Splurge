        ...
        <div class="flex items-center justify-between h-16">
            <div class="flex items-center justify-between">
                <div class="flex-shrink-0">
                    <img class="h-12 w-12" src="{{ asset('/images/v2/splurge.png') }}" alt="Splurge Logo">
                </div>
