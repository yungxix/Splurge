@php
    if (!function_exists("splurge_stat_url")) {
        function splurge_stat_url($item) {
            ...
            if (preg_match('/booking/i', $item['section']))  {
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="grid grid-cols-2 lg:grid-cols-3">
                        @foreach ($stats['counts'] as $item )
                            <a href="{{ splurge_stat_url($item) }}" class="focus:ring hover:ring ring-splarge-900 block md:flex flex-row rounded-md bg-zinc-100 m-4  overflow-clip">
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-3">
                        @foreach ($stats['dates'] as $item )
                            ...
                            <a href="{{ splurge_stat_url($item) }}"  class="block focus:ring hover:ring ring-splarge-900 md:flex flex-row rounded-md bg-zinc-100 m-4 overflow-clip">
